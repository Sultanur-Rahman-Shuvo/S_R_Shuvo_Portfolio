                    ...
                    >
                      ...
                      >
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3 group-hover:text-[#0097e6] dark:group-hover:text-blue-400 transition-colors duration-200 line-clamp-2">
                            {project.title}
                          </h3>
        ...
        >
          <div className="bg-gradient-to-r from-[#0097e6] to-[#7ed6df] rounded-2xl p-8 text-white">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 hover:scale-105"
            >
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-6 py-3 border-2 border-[#0097e6] text-[#0097e6] hover:bg-[#0097e6] hover:text-white font-semibold rounded-lg text-center transition-all duration-300 hover:scale-105"
                    >
                      Source Code
                    </a>
                  </div>
