...
const groupedSkills = [
  {
    ...
    skills: [
      ...
      { name: "WordPress Theme & Plugin Development", level: 80 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Convolutional Neural Network", level: 80 },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          {groupedSkills.map((group, groupIndex) => (
            ...
            >
              <div
                className={`${group.bgGradient} px-6 py-4 border-b border-gray-100 dark:border-gray-700`}
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${group.gradient} flex items-center justify-center text-white shadow-lg`}
                  >
                    {group.icon}
                  </div>
                  <div>
                    ...
                    >
                      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 hover:bg-white dark:hover:bg-gray-700 transition-all duration-300 border border-gray-200 dark:border-gray-600 hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-md">
                        <SkillBar
                          name={skill.name}
                          level={skill.level}
                          categoryGradient={group.gradient}
                        />
                      </div>
                    </motion.div>
                  ))}
