    ...
    <section id="home" className="min-h-[calc(100vh-80px)] flex items-center relative overflow-hidden py-20">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <div className="px-4">
            ...
            >
              Sultanur Rahman{" "}
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent floating">
                Shuvo
              </span>
            </h1>
            ...
            <div className="hero-cta flex flex-col sm:flex-row gap-4">
              <motion.a
                ...
                download
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 shadow-lg hover:scale-105 floating"
              ...
              <motion.a
                href="#about"
                className="inline-flex items-center gap-3 px-8 py-4 border-2 border-blue-600 text-blue-600 dark:text-blue-400 font-semibold rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300 floating"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
          ...
          >
            {/* Background effects */}
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur-3xl opacity-10 animate-pulse"></div>
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-200 to-purple-200 dark:from-blue-800 dark:to-purple-800 rounded-full opacity-20 animate-pulse"></div>
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-blue-500 rounded-full blur-xl opacity-30 animate-bounce"></div>
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-purple-500 rounded-full blur-xl opacity-30 animate-bounce" style={{ animationDelay: '1s' }}></div>
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <motion.div
          ...
          className="w-6 h-10 border-2 border-blue-500 rounded-full flex justify-center backdrop-blur-sm"
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
