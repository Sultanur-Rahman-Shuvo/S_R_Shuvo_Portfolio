        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            >
              <a
                href="#contact"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#0097e6] to-[#7ed6df] text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3 }}
                className="bg-gradient-to-r from-[#0097e6] to-[#7ed6df] rounded-2xl p-6 text-white text-center"
              >
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                <div className="w-2 h-8 bg-gradient-to-r from-[#0097e6] to-[#7ed6df] rounded-full"></div>
                My Philosophy
              </h3>
            ...
            >
              <h4 className="font-semibold text-white dark:text-white mb-3">Core Expertise</h4>
