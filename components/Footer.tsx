...
import { FiMail, FiLinkedin, FiGithub, FiTwitter, FiInstagram, FiYoutube, FiFacebook } from 'react-icons/fi'
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden flex flex-col items-center gap-6">
          ...
          >
            <p className="text-gray-600 dark:text-gray-300">West Pirerbag, Kamal Sarani, Mirpur, Dhaka-1216</p>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  {emailCopied ? (
                    <span className="text-xs text-[#00a8ff] dark:text-[#0097e6]">Copied!</span>
                  ) : (
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                      <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
        ...
        >
          <p className="text-sm text-gray-500 dark:text-gray-400">
            © {new Date().getFullYear()} Developed by <span className="text-[#00a8ff]">Sultanur Rahman Shuvo</span>. All rights reserved.
          </p>
        </motion.div>
      </div>
    </motion.footer>
